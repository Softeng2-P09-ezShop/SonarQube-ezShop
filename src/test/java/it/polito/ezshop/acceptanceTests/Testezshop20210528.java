...
public class Testezshop20210528 {
	...
	public void testCreateUser() {
		try {
			...
			Assert.assertTrue(
					getErrorMsg("testCreateUser", "returned id for role " + cashier + " is less then or equal to 0"),
					id > 0);
			id = ezshop.createUser(username2, userPwd, shopManager);
			Assert.assertTrue(getErrorMsg("testCreateUser",
					"returned id for role " + shopManager + " is less then or equal to 0"), id > 0);
			id = ezshop.createUser(username3, userPwd, admin);
			Assert.assertTrue(
					getErrorMsg("testCreateUser", "returned id for role " + admin + " is less then or equal to 0"),
					id > 0);
	...
	public void testCreateExistingUser() {
		try {
			int id = ezshop.createUser(username1, userPwd, cashier);
			Assert.assertTrue(getErrorMsg("testCreateExistingUser",
					"returned id for role " + cashier + " is less then or equal to 0"), id > 0);
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testCreateExistingUser", "The inserted roles should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testCreateExistingUser", "The inserted password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateExistingUser",
					"The inserted usernames should not be considered as invalid"));
		}
	}
	...
	public void testGetUserEmptyUsername() throws InvalidUsernameException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserEmptyUsername", "The inserted roles should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetUserEmptyUsername",
					"The inserted password should not be considered as invalid"));
		}
	}
	...
	public void testGetUserNullUsername() throws InvalidUsernameException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserNullUsername", "The inserted roles should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetUserNullUsername",
					"The inserted password should not be considered as invalid"));
		}
	}
	...
	public void testGetUserEmptyPassword() throws InvalidPasswordException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserEmptyPassword", "The inserted roles should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetUserEmptyPassword",
					"The inserted username should not be considered as invalid"));
		}
	}
	...
	public void testGetUserEmptyRole() throws InvalidRoleException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserEmptyRole", "The inserted password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserEmptyRole", "The inserted username should not be considered as invalid"));
		}
	}
	...
	public void testGetUserNullRole() throws InvalidRoleException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserNullRole", "The inserted password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetUserNullRole", "The inserted username should not be considered as invalid"));
		}
	}
	...
	public void testGetUserNotExistingRole() throws InvalidRoleException {
		try {
			...
			Assert.fail(
					getErrorMsg("testGetUserNotExistingRole", " \"role\" should not be considered as a valid role"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetUserNotExistingRole",
					"The inserted password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetUserNotExistingRole",
	...
	public void testDeleteUser() {
		try {
			...
			Assert.assertTrue(getErrorMsg("testDeleteUser", "delete of the inserted user should succeed"),
					ezshop.deleteUser(id));
			Assert.assertFalse(getErrorMsg("testDeleteUser", "delete of a deleted user should fail"),
					ezshop.deleteUser(id));
		} catch (InvalidRoleException e) {
			e.printStackTrace();
	...
	public void testDeleteUserNotAdmin1() throws UnauthorizedException {
		try {
			...
			ezshop.deleteUser(1);
			Assert.fail(
					getErrorMsg("testDeleteUserNotAdmin1", "delete made by a non admin account throw an exception"));
		} catch (InvalidUserIdException e) {
			e.printStackTrace();
	...
	public void testDeleteUserNotAdmin2() throws UnauthorizedException {
		try {
			...
			ezshop.deleteUser(1);
			Assert.fail(
					getErrorMsg("testDeleteUserNotAdmin2", "delete made by a non admin account throw an exception"));
		} catch (InvalidUserIdException e) {
			e.printStackTrace();
		...
		try {
			...
			for (User u : list) {
				if (u.getId() == id1 && !found1) {
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have username " + username1),
							username1, u.getUsername());
					Assert.assertEquals(getErrorMsg("testGetAllUsers", "user " + id1 + " should have role " + cashier),
							cashier, u.getRole());
					Assert.assertEquals(getErrorMsg("testGetAllUsers", "user " + id1 + " should have id " + id1), id1,
							u.getId().intValue());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have password " + userPwd), userPwd,
							u.getPassword());
					found1 = true;
				} else if (u.getId() == id2 && !found2) {
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have username " + username2),
							username2, u.getUsername());
					Assert.assertEquals(getErrorMsg("testGetAllUsers", "user " + id1 + " should have role " + admin),
							admin, u.getRole());
					Assert.assertEquals(getErrorMsg("testGetAllUsers", "user " + id1 + " should have id " + id2), id2,
							u.getId().intValue());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have password " + userPwd), userPwd,
							u.getPassword());
					...
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have username " + username3),
							username3, u.getUsername());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have role " + shopManager),
							shopManager, u.getRole());
					Assert.assertEquals(getErrorMsg("testGetAllUsers", "user " + id1 + " should have id " + id3), id3,
							u.getId().intValue());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + id1 + " should have password " + userPwd), userPwd,
							u.getPassword());
					...
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers",
									"user " + adminId + " should have username " + adminBaseUsername),
							adminBaseUsername, u.getUsername());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + adminId + " should have role " + admin), admin,
							u.getRole());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + adminId + " should have id " + adminId), adminId,
							u.getId().intValue());
					Assert.assertEquals(
							getErrorMsg("testGetAllUsers", "user " + adminId + " should have password " + adminBasePwd),
							adminBasePwd, u.getPassword());
					found4 = true;
				}
			}
			Assert.assertTrue(getErrorMsg("testGetAllUsers", "Not all users were found"),
	...
	public void testGetUser() {
		try {
			...
			Assert.assertEquals(getErrorMsg("testGetUser", "User " + id + " should have username " + username1),
					username1, res.getUsername());
			Assert.assertEquals(getErrorMsg("testGetUser", "User " + id + " should have id " + id), id,
					res.getId().intValue());
			Assert.assertEquals(getErrorMsg("testGetUser", "User " + id + " should have password " + userPwd), userPwd,
					res.getPassword());
			Assert.assertEquals(getErrorMsg("testGetUser", "User " + id + " should have role " + cashier), cashier,
					res.getRole());
		} catch (InvalidUserIdException e) {
			e.printStackTrace();
	...
	public void testUpdateUserRights() {
		try {
			Assert.assertFalse(
					getErrorMsg("testUpdateUserRights", "Update role of non existing user should return false"),
					ezshop.updateUserRights(100, cashier));
			int id = ezshop.createUser(username1, userPwd, cashier);
			Assert.assertTrue(getErrorMsg("testUpdateUserRights", "Update role of user " + id + " should return true"),
					ezshop.updateUserRights(id, admin));
			Assert.assertTrue(getErrorMsg("testUpdateUserRights", "Update role of user " + id + " should return true"),
	...
	public void testLogin() {
		try {
			...
			ezshop.logout();
			Assert.assertNull(getErrorMsg("testLogin", "The login should fail"),
					ezshop.login(adminBaseUsername, userPwd));
	...
	public void testLogout() {
		...
		Assert.assertFalse(getErrorMsg("testLogout", "The logout should fail if there is no logged user"),
				ezshop.logout());
	}
	...
	public void testCreateProductType() {
		try {
			...
			Assert.assertTrue(getErrorMsg("testCreateProductType", "The returned id should be a positive integer"),
					id > 0);
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductType",
					"The product description should not be considered as invalid"));
	...
	public void testCreateProductTypeNullDescription() {
		try {
			...
			Assert.assertTrue(
					getErrorMsg("testCreateProductTypeNullDescription", "The returned id should be a positive integer"),
					id > 0);
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullDescription",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullDescription",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullDescription",
					"The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testCreateExistingProductType() {
		try {
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			Assert.assertTrue(
					getErrorMsg("testCreateExistingProductType", "The returned id should be a positive integer"),
					id > 0);
			id = ezshop.createProductType("otherName", barCode, 10.0, note2);
			Assert.assertEquals(getErrorMsg("testCreateExistingProductType", "The returned id should be equal to -1"),
					-1, id);
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateExistingProductType",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateExistingProductType",
	...
	public void testCreateProductTypeNullType() throws InvalidProductDescriptionException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullType",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullType",
	...
	public void testCreateProductTypeEmptyType() throws InvalidProductDescriptionException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeEmptyType",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeEmptyType",
	...
	public void testCreateProductTypeNullCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNullCode",
	...
	public void testCreateProductTypeEmptyCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeEmptyCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeEmptyCode",
	...
	public void testCreateProductTypeInvalidCode() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(getErrorMsg("testCreateProductTypeInvalidCode",
					"The product code should not be considered as valid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeInvalidCode",
					"The product description should not be considered as invalid"));
	...
	public void testCreateProductTypeNegativePrice() throws InvalidPricePerUnitException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNegativePrice",
					"The product code should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNegativePrice",
	...
	public void testCreateProductTypeZeroPrice() throws InvalidPricePerUnitException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeZeroPrice",
					"The product code should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeZeroPrice",
	...
	public void testCreateProductTypeNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotLogged",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotLogged",
	...
	public void testCreateProductTypeNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotAuthorized",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotAuthorized",
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testCreateProductTypeNotAuthorized", "The role should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotAuthorized",
					"The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCreateProductTypeNotAuthorized",
					"The username should not be considered as invalid"));
		}
	}
	...
	public void testUpdateProduct() {
		try {
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr2, barCode, pricePerUnit, note1));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr1, barCode2, pricePerUnit, note1));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr1, barCode, pricePerUnit2, note1));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr1, barCode, pricePerUnit, ""));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr1, barCode, pricePerUnit, note2));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr1, barCode, pricePerUnit, null));
			Assert.assertTrue(getErrorMsg("testUpdateProduct", "The update should be successful"),
					ezshop.updateProduct(id, productDescr2, barCode2, pricePerUnit2, note2));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProduct", "The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testUpdateNotExistingProduct() {
		try {
			Assert.assertFalse(getErrorMsg("testUpdateNotExistingProduct", "The update should be successful"),
					ezshop.updateProduct(100, productDescr2, barCode, pricePerUnit, note1));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateNotExistingProduct",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateNotExistingProduct",
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateNotExistingProduct", "The product id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductNegativeId() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNegativeId",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNegativeId", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNegativeId",
					"The product price should not be considered as invalid"));
	...
	public void testUpdateProductZeroId() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductZeroId",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductZeroId", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductNullId() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNullId",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNullId", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductNullDescription() throws InvalidProductDescriptionException {
		try {
			...
			Assert.fail(getErrorMsg("testUpdateProductNullType",
					"The product description should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNullType", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNullType", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductEmptyDescription() throws InvalidProductDescriptionException {
		try {
			...
			Assert.fail(getErrorMsg("testUpdateProductEmptyType",
					"The product description should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyType", "The product id should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyType", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyType", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductNullCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNullCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNullCode", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductEmptyCode() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyCode", "The product code should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyCode", "The product id should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductEmptyCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductEmptyCode", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductInvalidCode() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testUpdateProductInvalidCode", "The product code should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductInvalidCode", "The product id should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductInvalidCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductInvalidCode",
	...
	public void testUpdateProductNegativePrice() throws InvalidPricePerUnitException {
		try {
			...
			Assert.fail(getErrorMsg("testUpdateProductNegativePrice",
					"The product price should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNegativePrice",
					"The product id should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNegativePrice",
					"The product description should not be considered as invalid"));
	...
	public void testUpdateProductZeroPrice() throws InvalidPricePerUnitException {
		try {
			...
			Assert.fail(
					getErrorMsg("testUpdateProductZeroPrice", "The product price should not be considered as valid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductZeroPrice", "The product id should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductZeroPrice",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductZeroPrice", "The product code should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateProductNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateProductNotLogged",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNotLogged", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNotLogged", "The product price should not be considered as invalid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateProductNotLogged", "The product id should not be considered as invalid"));
		}
	}
	...
	public void testDeleteProductType() {
		try {
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			Assert.assertTrue(getErrorMsg("testDeleteProductType", "The operation should not fail"),
					ezshop.deleteProductType(id));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductType",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testDeleteNotExistingProductType() {
		try {
			Assert.assertFalse(getErrorMsg("testDeleteNotExistingProductType", "The operation should not fail"),
					ezshop.deleteProductType(100));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteNotExistingProductType",
					"The product id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteProductTypeNegativeId() throws InvalidProductIdException {
		try {
			...
			Assert.fail(
					getErrorMsg("testDeleteProductTypeNegativeId", "The product id should not be considered as valid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteProductTypeNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductTypeNotLogged",
					"The product id should not be considered as invalid"));
		}
	}
	...
	public void testDeleteProductTypeNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductTypeNotAuthorized", "The role should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductTypeNotAuthorized",
					"The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductTypeNotAuthorized",
	...
	public void testGetAllProductTypes() {
		try {
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "There should be no product types"), 0,
					ezshop.getAllProductTypes().size());
			int id1 = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "There should be 1 product type"), 1,
					ezshop.getAllProductTypes().size());
			List<ProductType> products = ezshop.getAllProductTypes();
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product descriptions do not match"),
					productDescr1, products.get(0).getProductDescription());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product codes do not match"), barCode,
					products.get(0).getBarCode());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product prices do not match"), pricePerUnit,
					products.get(0).getPricePerUnit(), 0.0);
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product ids do not match"), id1,
					products.get(0).getId().intValue());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product notes do not match"), note1,
					products.get(0).getNote());

			int id2 = ezshop.createProductType(productDescr2, barCode2, pricePerUnit2, "");
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "There should be 2 product types"), 2,
					ezshop.getAllProductTypes().size());
			...
			for (ProductType t : products) {
				if (t.getId() == id1 && !match1) {
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product descriptions do not match"),
							productDescr1, t.getProductDescription());
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product codes do not match"),
							barCode, t.getBarCode());
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product prices do not match"),
							pricePerUnit, t.getPricePerUnit(), 0.0);
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product notes do not match"), note1,
							t.getNote());
					match1 = true;
				} else if (t.getId() == id2 && !match2) {
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product descriptions do not match"),
							productDescr2, t.getProductDescription());
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product codes do not match"),
							barCode2, t.getBarCode());
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product prices do not match"),
							pricePerUnit2, t.getPricePerUnit(), 0.0);
					Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product notes do not match"),
							emptyNote, t.getNote());
					match2 = true;
				} else
					break;
			}
			Assert.assertTrue(getErrorMsg("testGetAllProductTypes", "There should be both product types"),
					match1 && match2);

			Assert.assertTrue(getErrorMsg("testGetAllProductTypes", "The operation should not fail"),
					ezshop.deleteProductType(id1));
			products = ezshop.getAllProductTypes();
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "There should be 1 product type"), 1,
					products.size());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product descriptions do not match"),
					productDescr2, products.get(0).getProductDescription());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product codes do not match"), barCode2,
					products.get(0).getBarCode());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product prices do not match"), pricePerUnit2,
					products.get(0).getPricePerUnit(), 0.0);
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product ids do not match"), id2,
					products.get(0).getId().intValue());
			Assert.assertEquals(getErrorMsg("testGetAllProductTypes", "The product notes do not match"), emptyNote,
					products.get(0).getNote());
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetAllProductTypes",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testGetProductTypeByBarCode() {
		try {
			...
			Assert.assertNotNull(
					getErrorMsg("testGetProductTypeByBarCode", "There should be a product type with given bar code"),
					type);
			Assert.assertEquals(getErrorMsg("testGetProductTypeByBarCode", "The product description does not match"),
					productDescr1, type.getProductDescription());
			Assert.assertEquals(getErrorMsg("testGetProductTypeByBarCode", "The product code does not match"), barCode,
					type.getBarCode());
			Assert.assertEquals(getErrorMsg("testGetProductTypeByBarCode", "The product price does not match"),
					pricePerUnit, type.getPricePerUnit(), 0.0);
			Assert.assertEquals(getErrorMsg("testGetProductTypeByBarCode", "The product id does not match"), id,
					type.getId().intValue());
			Assert.assertEquals(getErrorMsg("testGetProductTypeByBarCode", "The product note does not match"), note1,
					type.getNote());
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypeByBarCode",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetProductTypeByBarCode", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypeByBarCode",
					"The product price should not be considered as invalid"));
	...
	public void testGetNotExistingProductTypeByBarCode() {
		try {
			ProductType type = ezshop.getProductTypeByBarCode(barCode);
			Assert.assertNull(getErrorMsg("testGetNotExistingProductTypeByBarCode",
					"There shouldn't be a product type with given bar code"), type);
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetNotExistingProductTypeByBarCode",
					"The product code should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testGetProductTypeByBarCodeEmpty() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testGetProductTypeByBarCodeEmpty", "The bar code should be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testGetProductTypeByBarCodeInvalid() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testGetProductTypeByBarCodeInvalid", "The bar code should be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testGetProductTypeByBarCodeNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypeByBarCodeNotLogged",
					"The bar code should not be considered invalid"));
		}
	}
	...
	public void testGetProductTypesByDescription() {
		try {
			...
			Assert.assertTrue(getErrorMsg("testGetProductTypesByDescription", "There should be no product types"),
					products.isEmpty());
			...
			Assert.assertEquals(getErrorMsg("testGetProductTypesByDescription", "There should be 2 product types"), 2,
					products.size());
			products = ezshop.getProductTypesByDescription(productDescr1);
			Assert.assertEquals(getErrorMsg("testGetProductTypesByDescription", "There should be 1 product type"), 1,
					products.size());
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypesByDescription",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypesByDescription",
	...
	public void testGetProductTypesByDescriptionNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypesByDescriptionNotAuthorized",
					"The role should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testGetProductTypesByDescriptionNotAuthorized",
					"The password should not be considered as invalid"));
	...
	public void testUpdateQuantity() {
		try {
			...
			Assert.assertTrue(getErrorMsg("testUpdateQuantity", "The operation should succeed"),
					ezshop.updateQuantity(id, quantity));
			ProductType product = ezshop.getProductTypeByBarCode(barCode);
			Assert.assertEquals(getErrorMsg("testUpdateQuantity", "The quantity should be updated"), quantity,
					product.getQuantity().intValue());

			Assert.assertTrue(getErrorMsg("testUpdateQuantity", "The operation should succeed"),
					ezshop.updateQuantity(id, quantity));
			product = ezshop.getProductTypeByBarCode(barCode);
			Assert.assertEquals(getErrorMsg("testUpdateQuantity", "The quantity should be updated"),
					quantity + quantity, product.getQuantity().intValue());
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantity", "The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testUpdateQuantityNotExisting() {
		try {
			Assert.assertFalse(getErrorMsg("testUpdateQuantityNotExisting", "The operation should not succeed"),
					ezshop.updateQuantity(100, quantity));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantityNotExisting", "The product id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateQuantityNoLocation() {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateQuantityNotExisting",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateQuantityNotExisting",
	...
	public void testUpdateQuantityNegative() {
		try {
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			ezshop.updatePosition(id, location1);
			Assert.assertTrue(getErrorMsg("testUpdateQuantityNegative", "The operation should succeed"),
					ezshop.updateQuantity(id, quantity));

			Assert.assertFalse(getErrorMsg("testUpdateQuantityNegative", "The operation should not succeed"),
					ezshop.updateQuantity(id, -(2 * quantity)));
			ProductType product = ezshop.getProductTypeByBarCode(barCode);
			Assert.assertEquals(getErrorMsg("testUpdateQuantityNegative", "The quantity should not be updated"),
					quantity, product.getQuantity().intValue());
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantityNegative", "The product id should not be considered as invalid"));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdateQuantityNegative",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantityNegative", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantityNegative", "The product price should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdateQuantityNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdateQuantityNotLogged", "The product id should not be considered as invalid"));
		}
	}
	...
	public void testUpdatePositionNegative() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdatePositionNegative",
					"The product location should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdatePositionZero() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdatePositionZero", "The product location should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdatePositionNull() throws InvalidProductIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdatePositionNull", "The product location should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdatePositionInvalidLocation1() throws InvalidLocationException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdatePositionInvalidLocation",
					"The product id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testUpdatePositionNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdatePositionNotLogged", "The product id should not be considered as invalid"));
		} catch (InvalidLocationException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdatePositionNotLogged",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testUpdatePositionNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdatePositionNotAuthorized", "The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testUpdatePositionNotAuthorized", "The username should not be considered as invalid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdatePositionNotAuthorized",
					"The product id should not be considered as invalid"));
		} catch (InvalidLocationException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testUpdatePositionNotAuthorized",
	...
	public void testIssueReorderWarning() {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarning",
					"The product description should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testIssueReorderWarning", "The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testIssueReorderWarning", "The product quantity should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testIssueReorderWarningNotExisting() {
		try {
			Assert.assertFalse(getErrorMsg("testIssueReorderWarningNotExisting", "The operation should fail"),
					ezshop.issueOrder(barCode, quantity, orderPricePerUnit) > 0);
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotExisting",
					"The product code should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotExisting",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotExisting",
					"The product price should not be considered as invalid"));
	...
	public void testIssueReorderWarningEmpty() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testIssueReorderWarningEmpty", "The product code should be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningEmpty",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningEmpty",
	...
	public void testIssueReorderWarningNull() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNull",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNull",
	...
	public void testIssueReorderWarningInvalid() throws InvalidProductCodeException {
		try {
			...
			Assert.fail(
					getErrorMsg("testIssueReorderWarningInvalid", "The product code should be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningInvalid",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningInvalid",
	...
	public void testIssueReorderWarningNegativeQuantity() throws InvalidQuantityException {
		try {
			...
			Assert.fail(getErrorMsg("testIssueReorderWarningNegativeQuantity",
					"The product quantity should be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNegativeQuantity",
					"The product code should not be considered as invalid"));
	...
	public void testIssueReorderWarningZeroQuantity() throws InvalidQuantityException {
		try {
			...
			Assert.fail(getErrorMsg("testIssueReorderWarningZeroQuantity",
					"The product quantity should be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningZeroQuantity",
	...
	public void testIssueReorderWarningNegativePrice() throws InvalidPricePerUnitException {
		try {
			...
			Assert.fail(getErrorMsg("testIssueReorderWarningNegativePrice",
					"The product price should be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNegativePrice",
					"The product code should not be considered as invalid"));
	...
	public void testIssueReorderWarningZeroPrice() throws InvalidPricePerUnitException {
		try {
			...
			Assert.fail(getErrorMsg("testIssueReorderWarningZeroPrice",
					"The product price should be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningZeroPrice",
	...
	public void testIssueReorderWarningNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotLogged",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotLogged",
	...
	public void testIssueReorderWarningNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotAuthorized",
					"The role should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testIssueReorderWarningNotAuthorized",
	...
	public void testSendOrderFor() {
		try {
			...
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			Assert.assertTrue(getErrorMsg("testSendOrderFor", "The operation should not fail"),
					ezshop.payOrderFor(barCode, quantity, orderPricePerUnit) > 0);
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
	...
	public void testSendOrderForNotExisting() {
		try {
			ezshop.recordBalanceUpdate(pricePerUnit * quantity);
			Assert.assertFalse(getErrorMsg("testSendOrderForNotExisting", "The operation should fail"),
					ezshop.payOrderFor(barCode, quantity, orderPricePerUnit) > 0);
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForNotExisting", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotExisting",
					"The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotExisting",
	...
	public void testSendOrderForNotEnoughMoney() {
		try {
			Assert.assertFalse(getErrorMsg("testSendOrderForNotEnoughMoney", "The operation should fail"),
					ezshop.payOrderFor(barCode, quantity, orderPricePerUnit) > 0);
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotEnoughMoney",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotEnoughMoney",
	...
	public void testSendOrderForNullBarCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNullBarCode",
					"The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNullBarCode",
	...
	public void testSendOrderForInvalidBarCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForInvalidBarCode",
					"The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForInvalidBarCode",
	...
	public void testSendOrderForNegativeQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNegativeQuantity",
					"The product price should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNegativeQuantity",
	...
	public void testSendOrderForZeroQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForZeroQuantity",
					"The product price should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForZeroQuantity",
	...
	public void testSendOrderForNegativePrice() throws InvalidPricePerUnitException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNegativePrice",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNegativePrice",
	...
	public void testSendOrderForZeroPrice() throws InvalidPricePerUnitException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForZeroPrice",
					"The product quantity should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForZeroPrice", "The product code should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testSendOrderForNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForNotLogged", "The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForNotLogged", "The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotLogged",
					"The product quantity should not be considered as invalid"));
		}
	}
	...
	public void testSendOrderForNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForNotAuthorized", "The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderForNotAuthorized", "The username should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotAuthorized",
					"The product code should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderForNotAuthorized",
	...
	public void testSendOrderNotEnoughMoney() {
		try {
			int id = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			int orderId = ezshop.issueOrder(barCode, quantity, orderPricePerUnit);
			Assert.assertFalse(getErrorMsg("testSendOrderNotEnoughMoney", "The operation should fail"),
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderNotEnoughMoney",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testSendOrderNotEnoughMoney",
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testSendOrderNotEnoughMoney", "The product code should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testRecordOrderArrival() {
		try {
			...
			int orderId = ezshop.issueOrder(barCode, quantity, orderPricePerUnit);
			ezshop.payOrder(orderId);
			Assert.assertTrue(getErrorMsg("testRecordOrderArrival", "The operation should not fail"),
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrival",
					"The product description should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderArrival", "The product quantity should not be considered as invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderArrival", "The product location should not be considered as invalid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
	...
	public void testRecordOrderArrivalNotExisting() {
		try {
			Assert.assertFalse(getErrorMsg("testRecordOrderArrivalNotExisting", "The operation should fail"),
					ezshop.recordOrderArrival(100));
		} catch (InvalidOrderIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalNotExisting",
					"The order id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testRecordOrderArrivalNegative() throws InvalidOrderIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalNegative",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testRecordOrderArrivalZero() throws InvalidOrderIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalZero",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testRecordOrderArrivalNull() throws InvalidOrderIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalNull",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testRecordOrderArrivalNoLoc() throws InvalidLocationException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderArrivalNoLoc", "The product type should not be considered as invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalNoLoc",
					"The product price should not be considered as invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderArrivalNoLoc",
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderArrivalNoLoc", "The product code should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testRecordOrderNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderNotLogged",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testRecordOrderNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderNotAuthorized", "The order id should not be considered as invalid"));
		} catch (InvalidRoleException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderNotAuthorized", "The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testRecordOrderNotAuthorized", "The username should not be considered as invalid"));
		} catch (InvalidLocationException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordOrderNotAuthorized",
					"The product location should not be considered as invalid"));
		}
	}
	...
	public void testGetAllOrdersNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetAllOrdersNotAuthorized", "The password should not be considered as invalid"));
		} catch (InvalidUsernameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testGetAllOrdersNotAuthorized", "The username should not be considered as invalid"));
		}
	}
	...
	public void testDefineExistingCustomer() {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDefineExistingCustomer", "The customer name should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testModifyCustomerNegativeId() throws InvalidCustomerIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerNegativeId", "Customer card should not be considered as invalid"));
		} catch (InvalidCustomerNameException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerNegativeId", "Customer name should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testModifyCustomerEmptyName() throws InvalidCustomerNameException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerEmptyName", "Customer card should not be considered as invalid"));
	...
	public void testModifyCustomerInvalidCard() throws InvalidCustomerCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerInvalidCard", "Customer name should not be considered as invalid"));
		} catch (InvalidCustomerIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerInvalidCard", "Customer id should not be considered as invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testModifyCustomerNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerNotLogged", "Customer name should not be considered as invalid"));
		} catch (InvalidCustomerIdException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyCustomerNotLogged", "Customer card should not be considered as invalid"));
		}
	}
	...
	public void testDeleteCustomer() {
		try {
			int id = ezshop.defineCustomer(customerName1);
			Assert.assertTrue(getErrorMsg("testDeleteCustomer", "The operation should not fail"),
	...
	public void testDeleteNotExistingCustomer() {
		try {
			Assert.assertFalse(getErrorMsg("testDeleteCustomer", "The operation should not fail"),
	...
	public void testCreateCard() {
		try {
			...
			Assert.assertTrue(getErrorMsg("testCreateCard", "The card has not a valid code"),
					isValidCustomerCard(card));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAttachCardToNonExistingCustomer() {
		try {
			Assert.assertFalse(getErrorMsg("testAttachCardToNonExistingCustomer", "This operation should fail"),
					ezshop.attachCardToCustomer(customerCard1, 100));
		} catch (InvalidCustomerIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAttachCardToNonExistingCustomer", "Customer id should not be considered invalid"));
		} catch (InvalidCustomerCardException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testAttachCardToNonExistingCustomer",
					"Customer card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAttachCardToCustomerNegativeId() throws InvalidCustomerIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testAttachCardToCustomerNegativeId",
					"Customer card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAttachCardToCustomerZeroId() throws InvalidCustomerIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAttachCardToCustomerZeroId", "Customer card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAttachCardToCustomerNullId() throws InvalidCustomerIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAttachCardToCustomerNullId", "Customer card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAttachCardToCustomerNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAttachCardToCustomerNotLogged", "Customer id should not be considered invalid"));
		} catch (InvalidCustomerCardException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAttachCardToCustomerNotLogged", "Customer card should not be considered invalid"));
		}
	}
	...
	public void testModifyPointsOnNonExistingCard() {
		try {
			Assert.assertFalse(getErrorMsg("testModifyPointsOnNonExistingCard", "This opearation should not fail"),
					ezshop.modifyPointsOnCard(customerCard1, point2));
		} catch (InvalidCustomerCardException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testModifyPointsOnNonExistingCard", "Customer card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAddProductToSale() {
		try {
			...
			Assert.assertFalse(getErrorMsg("testAddProductToSale", "This operation should fail"),
					ezshop.addProductToSale(100, barCode, quantity2));
			int transactionId = ezshop.startSaleTransaction();
			Assert.assertTrue(getErrorMsg("testAddProductToSale", "This operation should not fail"),
					ezshop.addProductToSale(transactionId, barCode, quantity2));
			Assert.assertFalse(getErrorMsg("testAddProductToSale", "This operation should fail"),
					ezshop.addProductToSale(transactionId, barCode, quantity));
			Assert.assertFalse(getErrorMsg("testAddProductToSale", "This operation should fail"),
					ezshop.addProductToSale(transactionId, barCode2, quantity2));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
	...
	public void testAddProductToSaleNegativeTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleNegativeTId", "Product amount should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleNegativeTId", "Product code should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAddProductToSaleEmptyCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleEmptyCode", "Product amount should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleEmptyCode", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAddProductToSaleInvalidCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleInvalidCode", "Product amount should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleInvalidCode", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAddProductToSaleNegativeQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testAddProductToSaleNegativeQuantity",
					"Product Code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testAddProductToSaleNegativeQuantity",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testAddProductToSaleNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleNotLogged", "Transaction id should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testAddProductToSaleNotLogged", "Product quantity should not be considered invalid"));
		}
	}
	...
	public void testDeleteProductFromSaleNegativeTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNegativeTId",
					"Product amount should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNegativeTId",
					"Product code should not be considered invalid"));
	...
	public void testDeleteProductFromSaleZeroTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductFromSaleZeroTId", "Product amount should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductFromSaleZeroTId", "Product Code should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteProductFromSaleNullTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductFromSaleNullTId", "Product amount should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductFromSaleNullTId", "Product Code should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteProductFromSaleEmptyCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleEmptyCode",
					"Product amount should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleEmptyCode",
	...
	public void testDeleteProductFromSaleNullCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNullCode",
					"Product amount should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNullCode",
	...
	public void testDeleteProductFromSaleInvalidCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleInvalidCode",
					"Product amount should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleInvalidCode",
	...
	public void testDeleteProductFromSaleNegativeQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNegativeQuantity",
					"Product code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNegativeQuantity",
	...
	public void testDeleteProductFromSaleNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNotLogged",
					"Transaction id should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteProductFromSaleNotLogged", "Product code should not be considered invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testDeleteProductFromSaleNotLogged",
					"Product quantity should not be considered invalid"));
		}
	}
	...
	public void testApplyDiscountRateToProductNegativeTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNegativeTId",
					"Discount rate should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNegativeTId",
					"Product code should not be considered invalid"));
	...
	public void testApplyDiscountRateToProductZeroTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductZeroTId",
					"Discount rate should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductZeroTId",
	...
	public void testApplyDiscountRateToProductNullTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNullTId",
					"Discount rate should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNullTId",
	...
	public void testApplyDiscountRateToProductNullCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNullCode",
					"Discount rate should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNullCode",
	...
	public void testApplyDiscountRateToProductEmptyCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductEmptyCode",
					"Discount rate should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductEmptyCode",
	...
	public void testApplyDiscountRateToProductInvalidCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductInvalidCode",
					"Discount rate should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductInvalidCode",
	...
	public void testApplyDiscountRateToProductNegative() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNegative",
					"Product code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNegative",
	...
	public void testApplyDiscountRateToProductFree() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testApplyDiscountRateToProductFree", "Product code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductFree",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToProductGreaterThan1() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductGreaterThan1",
					"Product code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductGreaterThan1",
	...
	public void testApplyDiscountRateToProductNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNotLogged",
					"Transaction id should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToProductNotLogged",
	...
	public void testApplyDiscountRateToSale() {
		try {
			...
			Assert.assertFalse(getErrorMsg("testApplyDiscountRateToSale", "This operation should fail"),
					ezshop.applyDiscountRateToSale(100, discountRate));
			int transactionId = ezshop.startSaleTransaction();
			ezshop.addProductToSale(transactionId, barCode, quantity2);
			ezshop.addProductToSale(transactionId, barCode2, 2 * quantity2);
			Assert.assertTrue(getErrorMsg("testApplyDiscountRateToSale", "This operation should not fail"),
					ezshop.applyDiscountRateToSale(transactionId, discountRate));
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testApplyDiscountRateToSale", "Product description should not be considered invalid"));
		} catch (InvalidPricePerUnitException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testApplyDiscountRateToSale", "Product quantity should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleNegativeTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleNegativeTId",
					"Discount rate should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleNullTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleNullTId",
					"Discount rate should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleZeroTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleZeroTId",
					"Discount rate should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleNegative() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleNegative",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleFree() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testApplyDiscountRateToSaleFree", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleGreaterThan1() throws InvalidDiscountRateException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleGreaterThan1",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testApplyDiscountRateToSaleNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleNotLogged",
					"Transaction id should not be considered invalid"));
		} catch (InvalidDiscountRateException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testApplyDiscountRateToSaleNotLogged",
	...
	public void testComputePointsForSaleNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testComputePointsForSaleNotLogged",
					"Transaction id should not be considered invalid"));
		}
	}
	...
	public void testDeleteSaleTicket() {
		try {
			...
			ezshop.updateQuantity(prodId, quantity);
			int id = ezshop.startSaleTransaction();
			Assert.assertTrue(getErrorMsg("testDeleteSaleTicket", "The operation shouldn't have failded"),
					ezshop.endSaleTransaction(id));
			SaleTransaction tick = ezshop.getSaleTransaction(id);
			Assert.assertTrue(getErrorMsg("testDeleteSaleTicket", "The operation should not fail"),
					ezshop.deleteSaleTransaction(tick.getTicketNumber()));
			Assert.assertNull(getErrorMsg("testDeleteSaleTicket", "The ticket should not exist"),
	...
	public void testCloseSaleTransaction() {
		try {
			Assert.assertFalse(getErrorMsg("testCloseSaleTransaction", "The operation should have failded"),
					ezshop.endSaleTransaction(100));
			int prodId = ezshop.createProductType(productDescr2, barCode2, pricePerUnit2, note2);
			ezshop.updateQuantity(prodId, quantity);
			int id = ezshop.startSaleTransaction();
			Assert.assertTrue(getErrorMsg("testCloseSaleTransaction", "The operation shouldn't have failded"),
					ezshop.endSaleTransaction(id));
			Assert.assertFalse(getErrorMsg("testCloseSaleTransaction", "The operation shoud have failed"),
					ezshop.addProductToSale(id, barCode2, quantity));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testCloseSaleTransaction", "Product description should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testCloseSaleTransactionNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testCloseSaleTransactionNotLogged",
					"Transaction id should not be considered invalid"));
		}
	}
	...
	public void testgetSaleTransaction() {
		try {
			...
			Assert.assertNull(getErrorMsg("testgetSaleTransaction", "Return value should have been null"),
			...
			Assert.assertNotNull(getErrorMsg("testgetSaleTransaction", "Return value should not have been null"),
					saleTransaction);
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
					discountRate, saleTransaction.getDiscountRate(), 0.0);
			double priceWithoutSaleDiscount = (quantity * pricePerUnit - quantity * pricePerUnit * discountRate)
					+ quantity * pricePerUnit2;// 17.50
			double priceWithSaleDiscount = priceWithoutSaleDiscount - (priceWithoutSaleDiscount * discountRate);
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
					priceWithSaleDiscount, saleTransaction.getPrice(), 0.0);
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), 2,
					saleTransaction.getEntries().size());
			boolean found1 = false;
			boolean found2 = false;
			double priceTmp = 0;
			for (TicketEntry entry : saleTransaction.getEntries()) {
				if (entry.getBarCode().equals(barCode) && !found1) {
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), quantity,
							entry.getAmount());
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), barCode,
							entry.getBarCode());
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
							discountRate, entry.getDiscountRate(), 0.0);
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
							pricePerUnit, entry.getPricePerUnit(), 0.0);
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
							productDescr1, entry.getProductDescription());
					...
					Assert.assertEquals(
							...
							entry.getAmount());
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), barCode2,
							entry.getBarCode());
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), 0.0,
							entry.getDiscountRate(), 0.0);
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
							pricePerUnit2, entry.getPricePerUnit(), 0.0);
					Assert.assertEquals(
							getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
							productDescr2, entry.getProductDescription());
					priceTmp += pricePerUnit2 * quantity;
					found2 = true;
				}
			}
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
					priceWithoutSaleDiscount, priceTmp, 0.0);
			Assert.assertTrue(getErrorMsg("testgetSaleTransaction", "Ticket has not the expected entries"),
					found1 && found2);
			...
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), 0.0,
					saleTransaction.getDiscountRate(), 0.0);
			priceWithoutSaleDiscount = quantity * pricePerUnit + quantity * pricePerUnit2;
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
					priceWithoutSaleDiscount, saleTransaction.getPrice(), 0.0);
			Assert.assertEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"), 2,
					saleTransaction.getEntries().size());
			found1 = false;
			found2 = false;
			...
			Assert.assertTrue(getErrorMsg("testgetSaleTransaction", "Ticket has not the expected entries"),
					found1 && found2);
			Assert.assertNotEquals(getErrorMsg("testgetSaleTransaction", "Return value is different than expected"),
					ticketNumber1, saleTransaction.getTicketNumber().intValue());
		} catch (InvalidProductDescriptionException e) {
			e.printStackTrace();
	...
	public void testgetSaleTransactionNonExistent() {
		try {
			Assert.assertNull(getErrorMsg("testgetSaleTransactionNonExistent", "Return value should be null"),
					ezshop.getSaleTransaction(100));
		} catch (InvalidTransactionIdException exc) {
			exc.printStackTrace();
			Assert.fail(getErrorMsg("testgetSaleTransactionNonExistent",
					"The transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testgetSaleTransactionNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testgetSaleTransactionNotLogged", "Transaction id should not be considered invalid"));
		}
	}
	...
	public void testStartReturnTransactionNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testStartReturnTransactionNotLogged",
					"Ticket number should not be considered invalid"));
		}
	}
	...
	public void testReturnProduct() {
		try {
			Assert.assertFalse(getErrorMsg("testReturnProduct", "Cannot return product without a transaction"),
			...
			Assert.assertTrue(getErrorMsg("testReturnProduct", "Return value should have been true"),
					ezshop.returnProduct(returnId, barCode, quantity));
			Assert.assertFalse(getErrorMsg("testReturnProduct", "Return value should have been false"),
					ezshop.returnProduct(returnId, barCode2, quantity));
			Assert.assertTrue(getErrorMsg("testReturnProduct", "Return value should have been true"),
					ezshop.returnProduct(returnId, barCode, quantity));
			Assert.assertFalse(getErrorMsg("testReturnProduct", "Return value should have been false"),
					ezshop.returnProduct(returnId, barCode2, quantity));
	...
	public void testReturnProductNegativeTId() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnProductNegativeTId", "Product quantity should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
	...
	public void testReturnProductInvalidCode() throws InvalidProductCodeException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnProductInvalidCode", "Product quantity should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
	...
	public void testReturnProductNegativeQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnProductNegativeQuantity", "Product code should not be considered invalid"));
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReturnProductNegativeQuantity",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReturnProductZeroQuantity() throws InvalidQuantityException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnProductZeroQuantity", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteReturnTransactionNegative() throws InvalidTransactionIdException {
		try {
			...
			Assert.fail(
					getErrorMsg("testDeleteReturnTransactionNegative", "Transaction id should be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testDeleteReturnTransactionNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testDeleteSaleTicketNotLogged", "Transaction id should not be considered invalid"));
		}
	}
	...
	public void testReceiveCashPayment() {
		try {
			Assert.assertFalse(getErrorMsg("testReceiveCashPayment", "Return value should have been false"),
					ezshop.receiveCashPayment(100, cash) >= 0);
			int prodId1 = ezshop.createProductType(productDescr1, barCode, pricePerUnit, note1);
			ezshop.updatePosition(prodId1, location1);
			ezshop.updateQuantity(prodId1, 10 * quantity);
			int transactionId = ezshop.startSaleTransaction();
			...
			ezshop.endSaleTransaction(transactionId);
			SaleTransaction saleTransaction = ezshop.getSaleTransaction(transactionId);
			Assert.assertEquals(getErrorMsg("testReceiveCashPayment", "There should be no change"), 0,
					ezshop.receiveCashPayment(saleTransaction.getTicketNumber(), cash * 2), 0.0);
			...
			Assert.assertEquals(getErrorMsg("testReceiveCashPayment", "There should be some change"), cash,
					ezshop.receiveCashPayment(saleTransaction.getTicketNumber(), cash * 2), 0.0);
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
	...
	public void testReceiveCashPaymentNegativeTicket() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveCashPaymentNegativeTicket", "Payment should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReceiveCashPaymentLessThanNeeded() {
		try {
			...
			ezshop.endSaleTransaction(transactionId);
			SaleTransaction saleTransaction = ezshop.getSaleTransaction(transactionId);
			Assert.assertEquals(getErrorMsg("testReceiveCashPaymentLessThanNeeded", "The operation should have failed"),
					-1, ezshop.receiveCashPayment(saleTransaction.getTicketNumber(), cash), 0.0);
		} catch (InvalidTransactionIdException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Transaction id should not be considered invalid"));
		} catch (InvalidProductIdException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveCashPaymentLessThanNeeded", "Product id should not be considered invalid"));
		} catch (InvalidQuantityException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Product quantity should not be considered invalid"));
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Product description should not be considered invalid"));
		} catch (InvalidProductCodeException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Product code should not be considered invalid"));
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Product price should not be considered invalid"));
		} catch (InvalidPaymentException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveCashPaymentLessThanNeeded", "Payment should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCashPaymentLessThanNeeded",
					"Product location should not be considered invalid"));
		}
	}
	...
	public void testReceiveCashPaymentNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveCashPaymentNotLogged", "Ticket Number should not be considered invalid"));
		} catch (InvalidPaymentException e) {
			e.printStackTrace();
	...
	public void testReceiveCreditCardPaymentNegativeTicket() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCreditCardPaymentNegativeTicket",
					"Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveCreditCardPaymentNegativeTicket", "The logged user should be authorized"));
		}
	}
	...
	public void testReceiveCreditCardPaymentZeroTicket() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCreditCardPaymentZeroTicket",
					"Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReceiveCreditCardPaymentNullTicket() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCreditCardPaymentNullTicket",
					"Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReceiveNullCreditCardPayment() throws InvalidCreditCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveNullCreditCardPayment", "Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReceiveInvalidCreditCardPayment() throws InvalidCreditCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReceiveInvalidCreditCardPayment", "Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReceiveCreditCardPaymentNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCreditCardPaymentNotLogged",
					"Ticket Number should not be considered invalid"));
		} catch (InvalidCreditCardException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReceiveCreditCardPaymentNotLogged",
	...
	public void testReturnCashPaymentNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnCashPaymentNotLogged", "Transaction id should not be considered invalid"));
		}
	}
	...
	public void testReturnCreditCardPaymentNegative() throws InvalidTransactionIdException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnCreditCardPaymentNegative", "Credit card should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReturnEmptyCreditCardPayment() throws InvalidCreditCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnEmptyCreditCardPayment", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReturnNullCreditCardPayment() throws InvalidCreditCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(
					getErrorMsg("testReturnNullCreditCardPayment", "Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReturnInvalidCreditCardPayment() throws InvalidCreditCardException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReturnInvalidCreditCardPayment",
					"Transaction id should not be considered invalid"));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testReturnCreditCardPaymentNotLogged() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReturnCreditCardPaymentNotLogged",
					"Transaction id should not be considered invalid"));
		} catch (InvalidCreditCardException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testReturnCreditCardPaymentNotLogged",
	...
	public void testRecordBalanceUpdate() {
		try {
			Assert.assertTrue(getErrorMsg("testRecordBalanceUpdate", "The operation should not fail"),
					ezshop.recordBalanceUpdate(quantity * pricePerUnit));
			double balance = ezshop.computeBalance();
			Assert.assertEquals(getErrorMsg("testRecordBalanceUpdate", "Balance does not match the expected value"),
					quantity * pricePerUnit, balance, 0.0);
			Assert.assertTrue(getErrorMsg("testRecordBalanceUpdate", "The operation should not fail"),
					ezshop.recordBalanceUpdate(-quantity * pricePerUnit));
			balance = ezshop.computeBalance();
			Assert.assertEquals(getErrorMsg("testRecordBalanceUpdate", "Balance does not match the expected value"), 0,
					balance, 0.0);
			Assert.assertFalse(getErrorMsg("testRecordBalanceUpdate", "The operation should fail"),
					ezshop.recordBalanceUpdate(-quantity * pricePerUnit));
		} catch (UnauthorizedException e) {
			e.printStackTrace();
	...
	public void testRecordBalanceUpdateNotAuthorized() throws UnauthorizedException {
		try {
			...
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordBalanceUpdateNotAuthorized",
					"The role should not be considered as invalid"));
		} catch (InvalidPasswordException e) {
			e.printStackTrace();
			Assert.fail(getErrorMsg("testRecordBalanceUpdateNotAuthorized",
